...
// Form submission by google app script
const SCRIPT_URL = "https://script.google.com/macros/s/AKfycbx7xfBDURjO-P89gTI4Q9QCuYSlBxRXajAPOD4E0BkOOgNXJmBSISSaBsMjirchK-y0/exec";
...
if (contactForm) {
    contactForm.addEventListener("submit", async function (e) {
        ...
        // Purani styling — submit button animation
        ...
        try {
            ...
            // Purani styling — success button text
            submitBtn.innerHTML = '<i class="fas fa-check"></i> Message Sent!';
            submitBtn.style.background = 'linear-gradient(135deg, var(--success), var(--accent))';

            // Purani styling — success animation
            createSuccessAnimation();

            contactForm.reset();

            // Purani styling — button reset after 3s
            setTimeout(() => {
...
// Purani styling — success animation function (same as before)
