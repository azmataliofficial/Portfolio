...
// Form Submission
const APPS_SCRIPT_URL = 'https://script.google.com/macros/s/AKfycbynUdSPptXvnGIT0X5AJvItUcsAkVlIhv41OFnlyWF5wBLOjMLpKSG-wa26egw-tQP9/exec';
...
function createSuccessAnimation() {
    ...
    successIcon.style.backgroundColor = 'rgba(255,255,255,0.9)';
    successIcon.style.borderRadius = '50%';
    successIcon.style.padding = '20px';
    successIcon.style.boxShadow = '0 10px 30px rgba(0,0,0,0.2)';
    ...
    animation.onfinish = () => successIcon.remove();
}
...
function setButtonLoading(button, isLoading) {
    if (isLoading) {
        ...
        button.innerHTML = '<i class="fas fa-spinner fa-pulse"></i> Sending...';
    } else {
...
function showMessage(elementId, isError = false) {
...
document.getElementById('contactForm').addEventListener('submit', async function (e) {
    ...
    const submitButton = document.getElementById('cf-btn');
